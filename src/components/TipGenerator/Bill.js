  ...
  return (
    <div className="">
      <div className="flex justify-between">
        <h4 className="font-bold text-zinc-500">Bill</h4>
        {errors.bill && touched.bill && (
          <h4 className="text-red-700 font-medium">{errors.bill}</h4>
        )}
      </div>
      <div className="flex justify-between w-full border-2 rounded-md px-3 hover:border-[#26b2bc] items-center mt-2 py-2 cursor-pointer">
